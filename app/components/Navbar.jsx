          ...
          <div className="hidden sm:block w-1/2">
            <div className="relative">
              ...
              <Search
                ...
                className="absolute right-4 top-1/2 transform -translate-y-1/2 cursor-pointer bg-red-500 rounded-full hover:bg-red-700 text-white transition-all w-8 h-8 p-1 duration-300"
              />
            </div>
          </div>
